...
#import "UIViewController+DDPopUpViewController_yf.h"
...
@interface UIViewController (DDPopUpViewControllerPrivate_yf)
...
@interface UINavigationController (DDPopUpViewControllerPrivate_yf)

@end

@implementation UINavigationController (DDPopUpViewControllerPrivate_yf)
