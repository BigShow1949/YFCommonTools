...
#import "UIViewController+StoreKit_yf.h"
...
@interface UIViewController (SKStoreProductViewControllerDelegate_yf) <SKStoreProductViewControllerDelegate>
...
@implementation UIViewController (StoreKit_yf)
